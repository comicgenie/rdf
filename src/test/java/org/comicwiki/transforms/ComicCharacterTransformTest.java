...
public class ComicCharacterTransformTest {
	...
	public void transformOnlyPrefix() throws Exception {
		...
		ComicCharacterTransform transform = new ComicCharacterTransform(personMatcher,
				repositories);
		transform.transform();		
	}
	...
	public void testFemalePrefix() throws Exception {
		...
		ComicCharacterTransform transform = new ComicCharacterTransform(personMatcher,
				repositories);
		assertEquals("Matilda", transform.removePrefixAndSuffix("Queen Matilda"));
	}
	...
	public void testNeutralPrefix() throws Exception {
		...
		ComicCharacterTransform transform = new ComicCharacterTransform(personMatcher,
				repositories);
		assertEquals("Useless", transform.removePrefixAndSuffix("Senator Useless"));
	}
