...
import org.comicwiki.gcdb.parser.CharacterBaseListener;
import org.comicwiki.gcdb.parser.CharacterParser.CharacterContext;
import org.comicwiki.gcdb.parser.CharacterParser.CharactersContext;
import org.comicwiki.gcdb.parser.CharacterParser.TeamAltContext;
import org.comicwiki.gcdb.parser.CharacterParser.TeamStandardContext;
import org.comicwiki.gcdb.tables.StoryTable;
import org.comicwiki.gcdb.tables.StoryTable.Fields;
import org.comicwiki.model.ComicCharacter;
import org.comicwiki.model.ComicOrganization;
import org.comicwiki.model.OrganizationType;

public class CharacterWalker extends CharacterBaseListener {

	private ArrayList<String> errors = new ArrayList<>();

	private HashMap<String, ComicCharacter> characters = new HashMap<>(5);

	private HashMap<String, ComicOrganization> organizations = new HashMap<>(2);
